...
/** @var App\SearchResults\Entity\SearchResultDataProvider $dataProvider */
/** @var \yii\web\View $this */
/** @var array $searchResults */
/** @var App\UrlShortener\Service\ViewMyHandler $handler */

$this->title = 'Мои короткие ссылки';
$this->params['meta_description'] = 'Список коротких ссылок пользователя, сохранненые результаты поиска пользователя';
...
<div class="row">
    <div class="col-md-8 d-flex align-items-center mb-3">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="<?= Url::to(['collections/index']) ?>">Все короткие ссылки</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active"  aria-current="page" href="<?= Url::to(['collections/view']) ?>">Мои ссылки</a>
            </li>
        </ul>
    </div>
    <div class="col-md-4">
