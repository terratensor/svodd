...
<div class="py-5">
  <div class="row">
    <div class="col-xl-8">
      ...
      <p class="bd-lead">Обратная хронология обсуждения событий, статистика комментариев в теме СВОДД и в остальных темах ФКТ.</p>
      <div class="d-flex flex-column flex-md-row gap-3">
        <a href="<?= \yii\helpers\Url::to(['svodd/view'])?>" class="btn btn-lg bd-btn-lg btn-bd-primary d-flex align-items-center justify-content-center btn-svodd">
